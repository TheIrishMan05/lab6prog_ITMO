...
import se.ifmo.collection.format.csv.converters.CoordinatesConverter;
import se.ifmo.collection.format.csv.converters.LocalDateTimeConverter;
import se.ifmo.collection.format.csv.converters.PersonConverter;
...
public class StudyGroup implements Comparable<StudyGroup>, Serializable {
    ...
    @CsvCustomBindByName(required = true, converter = PersonConverter.class)
